return {
  {
    ...
    opts = {
      ...
      completion = {
        ...
        documentation = {
          ...
          -- TODO: showing documentation automatically is pretty distracted
          auto_show = true,
    ...
    config = function(_, opts)
      -- replace nvim built-in <C-n/p> function in cmdline mode
      ...
      local opts_ext = {
        ...
        cmdline = {
          ...
          keymap = {
            ...
            --         return true -- skip the next(fallback) command/function
            --       end
            --     end
            --   end,
            --   "fallback",
      ...
      opts = vim.tbl_deep_extend("keep", opts, opts_ext)
