...
vim.g.completion = "blink" -- "blink" or "nvim-cmp"
-- vim.g.completion = "nvim-cmp" -- "blink" or "nvim-cmp"
vim.g.ai = "codeium" -- "codeium" or "copilot"
-- vim.g.ai = "copilot" -- "codeium" or "copilot"
